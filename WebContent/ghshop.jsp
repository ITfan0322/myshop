					...
					success : function(data) {
						...
						for (var i = 0; i < data.length; i++) {
							var str = "<tr id='sela'>"
								...
								+ "</td>"
								+ "<td>"
								+ "<div class='button-group'> <a class='button border-edit' href='javascript:void(0)' onclick='del("
								+ data[i].id
								+ ")'>"
								+ "<span class='icon-edit'></span> <span id='del"+data[i].id+"'>"+(data[i].status==0?"未审核":"已通过")+"</span></a> </div>"
								+ "</td>"
								+"</tr>";
