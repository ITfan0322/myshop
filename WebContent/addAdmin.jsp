        ...
        $.ajax({
        	...
        	success:function(res){
        		...
        		for(var i=0;i<res.length;i++){
        			var str = '<option value="'+res[i].name+'">'+res[i].name+'</option>'
        			$("#shops").append(str)
        		}
...
<div class="loading">
	...
	<div class="panel admin-panel">
		...
		<div class="body-content">
			<form class="form-x" action="insertAdmin" method="POST" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="field">
						<select name="shops" id="shops" class="input w50">
						</select>
						<div class="tips"></div>
					</div>
				</div> -->
        ...
        <div class="field">
         <input type="file" id="idFile" name="file1" width="150px"
							class="input tips" style="width: 25%;" runat="server"
							onchange="setImagePreview(this,localImag,preview)" />
						<div id="localImag">
							<img id="preview" alt="预览图片" src="" />
						</div>
        </div>
      </div>
      <if condition="$iscid eq 1">
          ...
          <div class="label">
            <label>类型：</label>
				...
				<div class="field" style="margin-left:10px;">
					<%-- 	<input id="certificatetype" value="${certificatetype}"
						type="hidden">  --%>
					
					<!-- <div class="tips"></div> -->
				</div>
			<!-- 	<div class="field">
					<select name="type1" class="input w50" id="text2" onchange="selectD();">
		...
		<div class="form-group">
			...
			<div class="field">
				<select name="level" class="input w50">
					...
					<option value="县/区级">县/区级</option>
					<option value="园区级">园区级</option>
				</select>
				<div class="tips"></div>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<textarea id="container" name="content"
				style="width: 800px; height: 400px; margin-left: 10%;"></textarea>
		</div> -->
