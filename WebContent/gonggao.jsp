					...
					success : function(data) {
						...
						var pstate = ''
							var str = "<tr id='sela'>"
								...
								+ (1)
								+ "</td>"
								+ "<td><input style='width:600px;border:none;border-bottom:1px solid #d4d4d4' id='tid' type='text'  value='"
								+ data.title
								+ "' /></td>"
								+ "<td>"
								+ "<div class='button-group'> <a class='button border-red' href='javascript:void(0)' onclick='update()'>"
								+ "<span class='icon-edit'></span> <span id='del'>修改</span></a> </div>"
								+"</td></tr>";
						$("#selectActivity").append(str);
